...
* **Sistemas de Controle Industrial (ICS/SCADA):** Ameaças à Segurança Cibernética e Influência dos Componentes de TI (CISA)
* **Gestão de Ameaças:** Gerenciamento de Ameaças Cibernéticas (IME)
* **Cisco Networking Academy:**
    * **Trilha Analista Júnior em Cyber Segurança**
    * **Hacker Ético & Network Defense** (com foco em Pentesting, Engenharia Social e Exploits)
    * **Cyber Threat Management**
* **Cybrary:** Offensive Security Operations, Cyber Kill Chains e OSINT.
* **Fundamentos:** Linux Unhatched (NDG/Cisco), Introduction to Cybersecurity (Cisco).
